"""
Read the DM workbook straight from SharePoint via Microsoft Graph.

No file is downloaded to disk and nothing is committed to git. The team edits
the workbook in SharePoint as normal; the dashboard pulls the current bytes on
each cache refresh.
...
Configuration lives in Streamlit secrets (or environment variables):
    ...
    SP_FILE_NAME     e.g. DM_Planing_Tracking_2026_25JUL26_V1_21.xlsx
