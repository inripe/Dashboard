"""
INRIPE DM PLANNING — view module (v4)
...
def render():
    """Draw the planning dashboard into the current container."""
    ...
    # ── HEADER ───────────────────────────────────────────────────────────
    st.markdown(
        "<div style='font-size:12px;color:#8A8A8A;margin:-6px 0 12px'>P4. Channel Plan &nbsp;&middot;&nbsp; auto-refreshes every 60s</div>", unsafe_allow_html=True)
